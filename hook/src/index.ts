...
function vi_start(a: string){
  if(a == "Сбер")
    return 'Данное приложение позволяет отслеживать количество выпитой воды. Для подробностей скажите "справка".';
  if(a == "Афина")
    return 'Данное приложение позволяет отслеживать количество выпитой воды. Для подробностей скажите "справка".';
  if(a == "Джой")
    return 'Данное приложение позволяет отслеживать количество выпитой воды. Для подробностей скажи "справка".';
}
