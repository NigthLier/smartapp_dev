      ...
      if(splitted.filter(word => word.indexOf('суточн') != -1 || word.indexOf('норм') != -1).length > 0){
        if(splitted.filter(word => word.indexOf('увелич') != -1).length > 0 || splitted.filter(word => word.indexOf('добав') != -1).length > 0){
          if(numbered != 0){
            ...
            upload(url, state);
            f = true;
            rsp.msg = 'Суточная норма увеличена на ' + numbered + ' ' + (splitted.filter(word => word.indexOf('миллилитр') != -1).length > 0 ? splitted.filter(word => word.indexOf('миллилитр') != -1) : 'миллилитров');
            yield rsp;
          }
        }
        if(splitted.filter(word => word.indexOf('уменьш') != -1).length > 0 || splitted.filter(word => word.indexOf('отним') != -1).length > 0){
          if(numbered != 0){
            ...
            upload(url, state);
            f = true;
            rsp.msg = 'Суточная норма уменьшена на ' + numbered + ' ' + (splitted.filter(word => word.indexOf('миллилитр') != -1).length > 0 ? splitted.filter(word => word.indexOf('миллилитр') != -1) : 'миллилитров');
            yield rsp;
          }
        }
        if(splitted.filter(word => word.indexOf('устан') != -1).length > 0 || splitted.filter(word => word.indexOf('пост') != -1).length > 0){
          if(numbered != 0){
            ...
            upload(url, state);
            f = true;
            rsp.msg = 'Установлена суточная норма в ' + numbered + ' ' + (splitted.filter(word => word.indexOf('миллилитр') != -1).length > 0 ? splitted.filter(word => word.indexOf('миллилитр') != -1) : 'миллилитров');
            yield rsp;
          }
        }
      }
      if(splitted.filter(word => word.indexOf('выпил') != -1 || word.indexOf('пью') != -1).length > 0){
        if(numbered != 0){
          if(r.msg.toLowerCase().indexOf('стакан') != -1){
            ...
            upload(url, state);
            f = true;
            rsp.msg = 'Вы выпили ' + numbered + ' ' + (splitted.filter(word => word.indexOf('миллилитр') != -1).length > 0 ? splitted.filter(word => word.indexOf('миллилитр') != -1) : 'миллилитров') + ', так держать!';
            yield rsp;
          }
        }
      }
